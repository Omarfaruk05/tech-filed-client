    ...
    <>
      <tr>
        ...
        <th className="text-center">
          ...
          <label htmlFor="modal-delete">
            <TrashIcon
              onClick={handleclick}
              className="w-5 h-5 text-red-500 btn btn-xs p-0 border-none bg-white hover:bg-white hover:border-none"
            ></TrashIcon>
          </label>
        </th>
      </tr>
          ...
          <div className="modal">
            <div className="modal-box relative">
              ...
              <p className="py-4">
                ...
                <span className="text-purple-700"> {myProduct.model}</span>
              </p>
              <button
      ...
      <div className="modal">
        <div className="modal-box w-11/12 max-w-5xl">
          ...
          <div>
            <InputGroup product={myProduct}></InputGroup>
          </div>
        </div>
      </div>
    </>
